    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto gap-8 grid md:grid-cols-3'>
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 '>
                ...
                <button className='bg-[#00df9a] w-[200px] rounded font-medium mx-auto px-6  py-3 my-6'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 '>
                ...
                <button className='bg-black text-[#00df9a] w-[200px] rounded font-medium mx-auto px-6  py-3 my-6'>Start Trial</button>
            </div>
            <div className='w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300 '>
